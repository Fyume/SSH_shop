...
<div class="User_title">回复我的</div><br>
...
<div id="MyReviews" class="MyReviews" style="background-color:#c0c0c0;">
	...
	<div style="background-color:#c0c0c0;border-bottom:1px white solid;">
		<div class="Myr_one" style="background-color: #c0c0c0;">
			...
			<c:choose>
				<c:when test="${sessionScope.user.uid eq rfr.user1.uid  }">
					<span style="color:blue;"> 你自己  </span>
				</c:when>
				<c:otherwise>
					<span style="color:blue;"> ${rfr.user1.username } </span>
				</c:otherwise>
			</c:choose>回复你: <span style="color:#575757;">(在<c:choose>
